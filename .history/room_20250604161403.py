...
class Room:
    def __init__(self, bounds=[(-10, 10), (-10, 10), (-10, 10)], reflection_eff=1.0, dimension=3):
        ...
        if dimension == 2:
            self.surfaces.append(PlaneWall([0, 1], [bounds[0][0], bounds[1][0]]), reflection_eff=reflection_eff)
            self.surfaces.append(PlaneWall([0, -1], [bounds[0][0], bounds[1][1]]), reflection_eff=reflection_eff)
            self.surfaces.append(PlaneWall([1, 0], [bounds[0][0], bounds[1][0]]), reflection_eff=reflection_eff)
            self.surfaces.append(PlaneWall([-1, 0], [bounds[0][1], bounds[1][0]]), reflection_eff=reflection_eff)
        elif dimension == 3:
            self.surfaces.append(PlaneWall([0, 0, 1], [bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall([0, 0, -1], [bounds[0][0], bounds[1][0], bounds[2][1]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall([0, 1, 0], [bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall([0, -1, 0], [bounds[0][0], bounds[1][1], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall([1, 0, 0], [bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall([-1, 0, 0], [bounds[0][1], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
        else:
...
class Receiver(Ellipsoid):
    def __init__(self, position, radii=(1.0, 1.0, 1.0), reflection_eff=1.0, type="physical"):
    ...
    def reflect(self, ray, intersection_point):
        ...
        if type == "physical":
            ...
            raise ValueError(f"Unsupported receiver type: {type}")
        self.record_hit(ray)
