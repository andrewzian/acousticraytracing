...
class Room:
    def __init__(self, bounds={'x': (-10, 10), 'y': (-10, 10), 'z': (-10, 10)}, reflection_eff=1.0, dimension=3):
        ...
        if dimension == 2:
            ...
            self.surfaces.append(PlaneWall(normal=[0, 1, 0], point=[bounds['x'][0], bounds['y'][0], bounds['z'][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, -1, 0], point=[bounds['x'][0], bounds['y'][1], bounds['z'][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[1, 0, 0], point=[bounds['x'][0], bounds['y'][0], bounds['z'][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[-1, 0, 0], point=[bounds['x'][1], bounds['y'][0], bounds['z'][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 0, 1], point=[bounds['x'][0], bounds['y'][0], bounds['z'][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 0, -1], point=[bounds['x'][0], bounds['y'][0], bounds['z'][1]], reflection_eff=reflection_eff))
        else:
