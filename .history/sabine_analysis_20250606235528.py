...
for _ in tqdm(range(n)):
    ...
    reflection_eff = np.random.uniform(0.20, 0.95)
    ...
    power = 10
    num_rays = int(10000 * (volume / max_dim**3))
    ...
    rt60_gaussian_schroeder = solution.get_RT60(kernel=gaussian(mu=5*sigma, sigma=sigma), method="schroeder")[0]
