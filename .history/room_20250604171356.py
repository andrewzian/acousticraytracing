...
class Room:
    def __init__(self, bounds=[(-10, 10), (-10, 10), (-10, 10)], reflection_eff=1.0, dimension=3):
        ...
        if dimension == 2:
            self.surfaces.append(PlaneWall(normal=[1, 0], point=[bounds[0][0], bounds[1][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[-1, 0], point=[bounds[0][1], bounds[1][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 1], point=[bounds[0][0], bounds[1][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, -1], point=[bounds[0][0], bounds[1][1]], reflection_eff=reflection_eff))
        elif dimension == 3:
            self.surfaces.append(PlaneWall(normal=[1, 0, 0], point=[bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[-1, 0, 0], point=[bounds[0][1], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 1, 0], point=[bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, -1, 0], point=[bounds[0][0], bounds[1][1], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 0, 1], point=[bounds[0][0], bounds[1][0], bounds[2][0]], reflection_eff=reflection_eff))
            self.surfaces.append(PlaneWall(normal=[0, 0, -1], point=[bounds[0][0], bounds[1][0], bounds[2][1]], reflection_eff=reflection_eff))
        else:
