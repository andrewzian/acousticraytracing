...
class Room:
    def __init__(self, bounds=[(-100, 100), (-100, 100), (-100, 100)], dimension=3):
        ...
        if dimension == 2:
            self.surfaces.append(PlaneWall([0, 1], [bounds[0][0], bounds[1][0]]))
            self.surfaces.append(PlaneWall([0, -1], [bounds[0][0], bounds[1][1]]))
            self.surfaces.append(PlaneWall([1, 0], [bounds[0][0], bounds[1][0]]))
            self.surfaces.append(PlaneWall([-1, 0], [bounds[0][1], bounds[1][0]]))
        elif dimension == 3:
            self.surfaces.append(PlaneWall([0, 0, 1], [bounds[0][0], bounds[1][0], bounds[2][0]]))
            self.surfaces.append(PlaneWall([0, 0, -1], [bounds[0][0], bounds[1][0], bounds[2][1]]))
            self.surfaces.append(PlaneWall([0, 1, 0], [bounds[0][0], bounds[1][0], bounds[2][0]]))
            self.surfaces.append(PlaneWall([0, -1, 0], [bounds[0][0], bounds[1][1], bounds[2][0]]))
            self.surfaces.append(PlaneWall([1, 0, 0], [bounds[0][0], bounds[1][0], bounds[2][0]]))
            self.surfaces.append(PlaneWall([-1, 0, 0], [bounds[0][1], bounds[1][0], bounds[2][0]]))
        else:
